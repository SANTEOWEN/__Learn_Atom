...
const EditJobPage = ({ updateJobSubmit }) => {
    ...
    //! Use params is use to get the key value of the selected data.
    const { id } = useParams();
    ...
    //* This tons of useStates represents as the getters and setters of data'
    //& For each states we initialize the values like (jobs.title) so that we get the data from the id that we are getting for example we get the id : 1 job it contains specific data on the fields so we can see it again then edit it.
