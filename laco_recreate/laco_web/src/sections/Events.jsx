...
const Events = () => {
    ...
    return (
        <>
            <section className="flex flex-col w-full min-h-60 bg-[#242526] mx-auto mt-[2rem] md:mt-10">
                <h1 className="md:text-6xl text-4xl text-center text-white">Events and Announcements</h1>
                <div className="w-full flex flex-row justify-center items-center p-10">
                    <div className={gridStyle}>
                        {events.map((({ img, title, content, date }, index) => {
                            return (
                                <div className="max-w-sm border rounded-lg shadow bg-gray-800 border-gray-700" key={index}>
