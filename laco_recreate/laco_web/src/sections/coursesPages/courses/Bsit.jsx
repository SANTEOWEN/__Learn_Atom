...
import { AppWindowMac, MoveRight, Code, HardDrive, Network, Shield, Earth } from 'lucide-react'
  ...
  return (
    <>
      <div className='max-h-full w-full flex lg:items-center flex-col z-50'>
        <h1 className="lg:mt-0 text-4xl font-extrabold leading-none tracking-tight md:text-5xl lg:text-6xl text-white">BACHELOR OF SCIENCE IN <span className='text-indigo-500'>INFORMATION TECHNOLOGY</span></h1>
        ...
        <div className='mx-auto px-6 max-w-7xl text-gray-500 mt-10'>
          <div className="relative">
            <div className="relative  grid gap-3 grid-cols-6">
              ...
              <div className='group col-span-full lg:col-span-4 overflow-hidden flex relative p-8 rounded-xl bg-[#1f2937] border border-indigo-500'>
                <div className='size-fit m-auto relatives'>
                  <div className='group relative h-28 w-full flex items-start justify-start'>
                    <AppWindowMac className='w-fit block mx-auto' size={100} color='white' />
                  </div>
                  <div className='flex flex-col justify-center'>
                    <h2 className="mt-6 text-center font-medium text-gray-300">Operating systems</h2>
                    <p className='text-center text-base'>Study of different operating systems and their management.</p>
                  </div>
                </div>
              </div>

              <div className="group col-span-full sm:col-span-3 lg:col-span-2 overflow-hidden relative p-8 rounded-xl bg-[#1f2937] border border-indigo-500">
                ...
                <div>
                  <div className="relative aspect-square rounded-full size-32 flex border mx-auto dark:bg-white/5 dark:border-white/10 before:absolute before:-inset-2 before:border dark:before:border-white/5 dark:before:bg-white/5 before:rounded-full">
                    <Code className='w-24 m-auto h-fit' color='white' />
                  </div>
                  <div className="mt-6 text-center relative space-y-2">
                    <h2 className="text-lg font-medium text-gray-300">Programming and software development</h2>
                    <p className="text-center text-base">Skills in various programming languages and software development practices.</p>
                  </div>
                </div>
              ...
              <div className="group col-span-full sm:col-span-3 lg:col-span-2 overflow-hidden relative p-8 rounded-xl bg-[#1f2937] border border-indigo-500">
                ...
                <div>
                  <div className="relative aspect-square rounded-full size-32 flex border mx-auto dark:bg-white/5 dark:border-white/10 before:absolute before:-inset-2 before:border dark:before:border-white/5 dark:before:bg-white/5 before:rounded-full">
                    <Network className='w-24 m-auto h-fit' color='white' />
                  </div>

                  <div className="mt-6 text-center relative space-y-2">
                    <h2 className="text-lg font-medium text-gray-300">Computer networking</h2>
                    <p className="text-center text-base">Understanding network architectures, protocols, and hardware.</p>
                  </div>
                </div>

              </div>

              <div className="col-span-full lg:col-span-4 overflow-hidden relative p-8 rounded-xl bg-[#1f2937] border border-indigo-500">
                <div className="grid sm:grid-cols-2">
                  <div className="flex flex-col justify-between relative space-y-12 lg:space-y-6">
                    <div className="relative aspect-square rounded-full size-12 flex border dark:bg-white/5 dark:border-white/10 before:absolute before:-inset-2 before:border dark:before:border-white/5 dark:before:bg-white/5 before:rounded-full">
                      <HardDrive className='size-6 m-auto' color='white' />
                    </div>
                    <div className="space-y-2">
                      <h2 className="text-lg font-medium text-gray-300">Databases and data management</h2>
                      <p className='text-base '>Principles of database design, implementation, and management of large-scale data.</p>
                    </div>
                  </div>
              ...
              <div className="col-span-full sm:col-span-3 lg:col-span-2 overflow-hidden relative p-8 rounded-xl bg-[#1f2937] border border-indigo-500">
                <div>

                  <Shield className='w-24 m-auto h-fit' color='white' />

                  <div className="mt-6 text-center relative space-y-2">
                    <h2 className="text-lg font-medium text-gray-300">Cybersecurity</h2>
                    <p className="text-center text-base">Techniques for identifying, preventing, and responding to security threats.</p>
                  </div>
                </div>
              </div>

              <div className="col-span-full sm:col-span-3 lg:col-span-4 overflow-hidden relative p-8 rounded-xl bg-[#1f2937] border border-indigo-500">
                <div>

                  <Earth className='w-24 m-auto h-fit' color='white' />

                  <div className="mt-6 text-center relative space-y-2">
                    <h2 className="text-lg font-medium text-gray-300">Web development</h2>
                    <p className="text-center text-base">Building dynamic, interactive, and user-friendly web applications.</p>
                  </div>
