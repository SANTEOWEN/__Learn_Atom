...
function Bscs() {
    return (
        <>
            <div className='max-h-full w-full flex lg:items-center flex-col'>
                <h1 className="lg:mt-0 text-4xl font-extrabold leading-none tracking-tight md:text-5xl lg:text-6xl text-white">BACHELOR OF SCIENCE IN <span className='text-cyan-500'>COMPUTER SCIENCE</span></h1>
                <p className="mt-3 text-lg font-normal lg:text-base sm:px-16 xl:px-48 text-start lg:text-center text-ellipsis text-gray-400">The BSCS program is a study of concepts and theories, algorithmic foundations, plementation and application of information and computing solutions. It prepares students to be I.T professional, researchs, and to be proficient in designing and developing computing solutions.</p>
                <p className='hidden lg:block mt-3 text-lg font-normal  lg:text-base sm:px-16 xl:px-48 text-start lg:text-center text-ellipsis text-gray-400'>The curriculum is based on the stantards set by the Commision on Higher Education (CHED) and is benchmarked from the curricula of leading academic institutions, national and international, offering similar business programs, and addresses the needs of the industry.</p>

                <div className='mx-auto px-6 max-w-6xl text-gray-500 mt-10'>
                    <div className="relative">
                        <div className="relative grid gap-3 grid-cols-6">
                            ...
                            <div className='group col-span-full lg:col-span-2 overflow-hidden flex relative p-8 rounded-xl bg-[#1f2937] border border-cyan-500'>
                                <div className='size-fit m-auto relatives'>
                                    ...
                                    <div className='flex flex-col justify-center'>
                                        <h2 className="mt-6 text-center font-medium text-cyan-500">Data Structure and Algorithm</h2>
                                        <p className='text-center text-sm'>In-depth study of fundamental algorithms and data structures for efficient problem-solving.</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="group col-span-full sm:col-span-3 lg:col-span-2 overflow-hidden relative p-8 rounded-xl bg-[#1f2937] border border-green-500">
                                ...
                                <div>
                                    <div className="relative aspect-square rounded-full size-32 flex border mx-auto dark:bg-white/5 dark:border-white/10 before:absolute before:-inset-2 before:border dark:before:border-white/5 dark:before:bg-white/5 before:rounded-full">
                                        <Binary className='w-24 m-auto h-fit' color='white' />
                                    </div>
                                    <div className="mt-6 text-center relative space-y-2">
                                        <h2 className="text-lg font-medium text-green-500">Programming languages and paradigms</h2>
                                        <p className="text-center text-sm">Examination of various programming languages and programming paradigms.</p>
                                    </div>
                                </div>

                            </div>

                            <div className="group col-span-full sm:col-span-3 lg:col-span-2 overflow-hidden relative p-8 rounded-xl bg-[#1f2937] border border-yellow-300">

                                <div>
                                    <div className="relative aspect-square rounded-full size-32 flex border mx-auto dark:bg-white/5 dark:border-white/10 before:absolute before:-inset-2 before:border dark:before:border-white/5 dark:before:bg-white/5 before:rounded-full">
                                        <ShieldCheck className='w-24 m-auto h-fit' color='white' />
                                    </div>

                                    <div className="mt-6 text-center relative space-y-2">
                                        <h2 className="text-lg font-medium text-yellow-300">Computer networks and cybersecurity</h2>
                                        <p className="text-center text-sm">Provident fugit vero voluptate. magnam magni doloribus dolores voluptates inventore nisi.</p>
                                    </div>
                                </div>

                            </div>

                            <div className="col-span-full lg:col-span-3 overflow-hidden relative p-8 rounded-xl bg-[#1f2937] border border-rose-600">
                                <div className="grid sm:grid-cols-2">
                                    <div className="flex flex-col justify-between relative space-y-12 lg:space-y-6">
                                        <div className="relative aspect-square rounded-full size-12 flex border dark:bg-white/5 dark:border-white/10 before:absolute before:-inset-2 before:border dark:before:border-white/5 dark:before:bg-white/5 before:rounded-full">
                                            <Database className='size-6 m-auto' color='white' />
                                        </div>
                                        <div className="space-y-2">
                                            <h2 className="text-lg font-medium text-rose-600">Databases and data management</h2>
                                            <p>Principles of database design, implementation, and management of large-scale data.</p>
                                        </div>
                                    </div>
                            ...
                            <div className="col-span-full sm:col-span-3 lg:col-span-3 overflow-hidden relative p-8 rounded-xl bg-[#1f2937] border border-orange-500">
                                <div>

                                    <Brain className='w-24 m-auto h-fit' color='white' />

                                    <div className="mt-6 text-center relative space-y-2">
                                        <h2 className="text-lg font-medium text-orange-500">Artificial intelligence and machine learning</h2>
                                        <p className="text-center text-sm">Exploration of AI concepts, algorithms, and applications.</p>
                                    </div>
                                </div>
                            </div>

                            <div className="col-span-full sm:col-span-3 lg:col-span-6 overflow-hidden relative p-8 rounded-xl bg-[#1f2937] border border-purple-500">
                                <div>

                                    <Proportions className='w-24 m-auto h-fit' color='white' />

                                    <div className="mt-6 text-center relative space-y-2">
                                        <h2 className="text-lg font-medium text-purple-500">Mobile and web application development</h2>
                                        <p className="text-center text-sm">Skills to build modern, responsive, and user-friendly mobile and web applications.</p>
                                    </div>

                                </div>
                            </div>

                            <Link to={`/Courses`} className={`w-80 p-5 flex justify-between items-center group`}>
