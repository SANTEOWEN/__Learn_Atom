                ...
                <div className='mx-auto px-6 max-w-7xl text-gray-500 mt-10'>
                    <div className="relative">
                        <div className="relative  grid gap-3 grid-cols-6">
                            ...
                            <div className='group col-span-full lg:col-span-2 overflow-hidden flex relative p-8 rounded-xl bg-[#1f2937] backdrop-blur-md border border-cyan-500'>
                                <div className='size-fit m-auto relatives'>
                                    ...
                                    <div className='flex flex-col justify-center'>
                                        <h2 className="mt-6 text-center font-medium text-white">Data Structure and Algorithm</h2>
                            ...
                            <div className="group col-span-full sm:col-span-3 lg:col-span-2 overflow-hidden relative p-8 rounded-xl bg-[#1f2937] border border-cyan-500">
                                ...
                                <div>
                                    ...
                                    <div className="mt-6 text-center relative space-y-2">
                                        <h2 className="text-lg font-medium text-white">Programming languages and paradigms</h2>
                            ...
                            <div className="group col-span-full sm:col-span-3 lg:col-span-2 overflow-hidden relative p-8 rounded-xl bg-[#1f2937] border border-cyan-500">
                                ...
                                <div>
                                    ...
                                    <div className="mt-6 text-center relative space-y-2">
                                        <h2 className="text-lg font-medium text-white">Computer networks and cybersecurity</h2>
                            ...
                            <div className="col-span-full lg:col-span-3 overflow-hidden relative p-8 rounded-xl bg-[#1f2937] border border-cyan-500">
                                <div className="grid sm:grid-cols-2">
                                    <div className="flex flex-col justify-between relative space-y-12 lg:space-y-6">
                                        ...
                                        <div className="space-y-2">
                                            <h2 className="text-lg font-medium text-white">Databases and data management</h2>
                            ...
                            <div className="col-span-full sm:col-span-3 lg:col-span-3 overflow-hidden relative p-8 rounded-xl bg-[#1f2937] border border-cyan-500">
                                <div>

                                    <Brain className='w-24 m-auto h-fit' color='white' />

                                    <div className="mt-6 text-center relative space-y-2">
                                        <h2 className="text-lg font-medium text-white">Artificial intelligence and machine learning</h2>
                                        <p className="text-center text-sm">Exploration of AI concepts, algorithms, and applications.</p>
                                    </div>
                                </div>
                            </div>

                            <div className="col-span-full sm:col-span-3 lg:col-span-6 overflow-hidden relative p-8 rounded-xl bg-[#1f2937] border border-cyan-500">
                                <div>

                                    <Proportions className='w-24 m-auto h-fit' color='white' />

                                    <div className="mt-6 text-center relative space-y-2">
                                        <h2 className="text-lg font-medium text-white">Mobile and web application development</h2>
