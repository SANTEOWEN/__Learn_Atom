        ...
        <section className='mx-auto px-8 py-20 lg:py-40 bg-[#1d232f]'>
            {isMainCoursePage ? (
                <>
                    ...
                    <p className="block antialiased font-sans text-xl font-normal leading-relaxed text-inherit mt-2 w-full lg:w-5/12 !text-gray-500">List of our popular courses.</p>
